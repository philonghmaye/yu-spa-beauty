/**
 * Bảng dịch tên dịch vụ/danh mục Việt → Anh.
 * Tách riêng để lazy-load chỉ khi user chọn tiếng Anh,
 * giảm bundle ban đầu ~26KB.
 */
...
export const keywordMap: [RegExp, string][] = [
