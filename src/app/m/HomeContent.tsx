      ...
      <div style={{ padding: '0 16px' }}>
        <Link href="/m/dich-vu" style={{ textDecoration: 'none', color: 'inherit' }}>
          <div style={{
            ...
            <Image src="/uploads/banner-beauty.png" alt={t.beautyServices} fill sizes="(max-width: 480px) 100vw, 480px" style={{ objectFit: 'cover' }} priority />
              ...
              <div style={{ width: 130, textAlign: 'center' }}>
                <div style={{
                  ...
                  {(s.images[0]?.url || s.user.avatar) ? (
                    <Image src={s.images[0]?.url || s.user.avatar || ''} alt={s.user.name} width={90} height={90} style={{ objectFit: 'cover' }} />
                  ) : (
